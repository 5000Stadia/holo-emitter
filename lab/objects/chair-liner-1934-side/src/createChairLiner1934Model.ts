...
export function createChairLiner1934Model(options: ProceduralModelOptions = {}): THREE.Group {
  ...
  socket_back_shell_shell_top_edge_0.position.set(0.046, 0.03782, 0.35069);
  socket_back_shell_shell_top_edge_0.rotation.set(0, 0, 0);
  socket_back_shell_shell_top_edge_0.userData.socket = {"id": "shell-top-edge", "localPosition": [0.046, 0.03782, 0.35069], "axis": [0.0, 0.0, 1.0], "purpose": "bonded run for the rolled top edge", "confidence": 0.9};
  ...
  if (endpoint_leg_front_l_3) {
    ...
    node_leg_front_l_3.position.set(0.207, 0.418, 0.177);
    node_leg_front_l_3.rotation.set(0.0, 0.0, 0.0);
  }
  ...
  if (endpoint_leg_front_r_4) {
    ...
    node_leg_front_r_4.position.set(-0.207, 0.418, 0.177);
    node_leg_front_r_4.rotation.set(0.0, 0.0, 0.0);
  }
  ...
  if (endpoint_leg_rear_l_5) {
    ...
    node_leg_rear_l_5.position.set(0.207, 0.418, -0.177);
    node_leg_rear_l_5.rotation.set(0.0, 0.0, 0.0);
  }
  ...
  if (endpoint_leg_rear_r_6) {
    ...
    node_leg_rear_r_6.position.set(-0.207, 0.418, -0.177);
    node_leg_rear_r_6.rotation.set(0.0, 0.0, 0.0);
  }
