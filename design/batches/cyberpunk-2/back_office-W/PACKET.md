# back_office/W — technique t2 (labelled scaffold)
...
| roll 1 | `backdrops/source/back_office-W/row23-6afb2c06.png` |

The prompt files are already on disk beside them. Do not rewrite them.

This wall: 273.1 px per metre at the wall plane, door.
