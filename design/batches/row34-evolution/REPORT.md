...
## Generation 2, planned by the rule written before generation 1 returned

Branch **B**. 24 rolls of a declared 28.

- `v3` — the control, re-rolled fresh
- `v2A` — amplified (needs a composer)
- `v6A` — amplified (needs a composer)
- `v2xv6m2` — crossing (needs a composer)
- `v2xv6m4` — crossing (needs a composer)
- `v4` — opposite extreme of the image/text spectrum
