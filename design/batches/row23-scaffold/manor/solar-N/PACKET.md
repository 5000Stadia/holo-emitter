# solar/N — technique t2 (labelled scaffold)
...
| roll 1 | `backdrops/source/solar-N/row23-a144efb4.png` |
| roll 2 | `backdrops/source/solar-N/row23-0d155462.png` |

The prompt files are already on disk beside them. Do not rewrite them.

This wall: 115.7 px per metre at the wall plane, fireplace + window + window.
