# entrance_court/S — technique t2 (labelled scaffold)
...
| roll 1 | `backdrops/source/entrance_court-S/row23-1fbb1f98.png` |
| roll 2 | `backdrops/source/entrance_court-S/row23-93aabf08.png` |

The prompt files are already on disk beside them. Do not rewrite them.

This wall: 38.3 px per metre at the wall plane, no carrier — unbroken panelling.
