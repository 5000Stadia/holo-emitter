# entrance_court/S — RE-ASK 3 (technique t2, labelled scaffold)
...
| roll 1 | `backdrops/source/entrance_court-S/row23-27eb4f6f.png` |
| roll 2 | `backdrops/source/entrance_court-S/row23-f26273dd.png` |

The prompt files are already on disk beside them. Do not rewrite them.

This wall: 38.3 px per metre at the wall plane, no carrier — an unbroken low boundary wall under open sky.
