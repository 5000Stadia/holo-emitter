# servants_hall/E — technique t2 (labelled scaffold)
...
| roll 1 | `backdrops/source/servants_hall-E/row23-f8c7ac49.png` |
| roll 2 | `backdrops/source/servants_hall-E/row23-a1213e7d.png` |

The prompt files are already on disk beside them. Do not rewrite them.

This wall: 170.7 px per metre at the wall plane, window + fireplace.
