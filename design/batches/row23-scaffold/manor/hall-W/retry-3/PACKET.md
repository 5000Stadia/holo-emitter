...
| roll 1 | `backdrops/source/passage-W/row23-ace02876.png` |
| roll 2 | `backdrops/source/passage-W/row23-2ff714c8.png` |

The prompt files are already on disk beside them. Do not rewrite them.

This wall: 170.7 px per metre at the wall plane, door.
Voice: **cross_passage** (room id); gate anchor **the wainscot chair-rail above the floor**, 0.95 m.
