# kitchen/S — technique t2 (labelled scaffold)
...
| roll 1 | `backdrops/source/kitchen-S/row23-a9b38d42.png` |
| roll 2 | `backdrops/source/kitchen-S/row23-7de99c6d.png` |

The prompt files are already on disk beside them. Do not rewrite them.

This wall: 157.8 px per metre at the wall plane, fireplace + window.
