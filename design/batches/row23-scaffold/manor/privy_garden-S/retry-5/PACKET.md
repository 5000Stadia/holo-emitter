# privy_garden/S — RE-ASK 5 (technique t2, labelled scaffold)
...
| roll 1 | `backdrops/source/privy_garden-S/row23-8573c041.png` |

The prompt files are already on disk beside them. Do not rewrite them.

This wall: 200.8 px per metre at the wall plane, door + window.
