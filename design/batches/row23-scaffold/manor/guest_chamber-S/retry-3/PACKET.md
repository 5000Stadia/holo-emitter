# guest_chamber/S — RE-ASK 3 (technique t2, labelled scaffold)
...
| roll 1 | `backdrops/source/guest_chamber-S/row23-a64f40f9.png` |
| roll 2 | `backdrops/source/guest_chamber-S/row23-ce78b632.png` |

The prompt files are already on disk beside them. Do not rewrite them.

This wall: 170.7 px per metre at the wall plane, fireplace + door.
