# buttery_pantry/E — technique t2 (labelled scaffold)
...
| roll 1 | `backdrops/source/buttery_pantry-E/row23-7c019f47.png` |
| roll 2 | `backdrops/source/buttery_pantry-E/row23-f080a457.png` |

The prompt files are already on disk beside them. Do not rewrite them.

This wall: 170.7 px per metre at the wall plane, window.
