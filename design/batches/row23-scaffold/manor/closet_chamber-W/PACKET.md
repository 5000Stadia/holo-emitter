# closet_chamber/W — technique t2 (labelled scaffold)
...
| roll 1 | `backdrops/source/closet_chamber-W/row23-fc09b6a5.png` |
| roll 2 | `backdrops/source/closet_chamber-W/row23-e8ff7ef4.png` |

The prompt files are already on disk beside them. Do not rewrite them.

This wall: 155.2 px per metre at the wall plane, no carrier — unbroken panelling.
