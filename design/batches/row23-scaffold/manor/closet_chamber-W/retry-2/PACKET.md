# closet_chamber/W — CONSISTENCY RE-ASK 2 (technique t2, labelled scaffold)
...
Attach `style-reference.png` as **Image 1** (closet_chamber/N, this room's own wall), `scaffold.png` as **Image 2** and `edge-seed-right.png` as **Image 3**, in that
...
| roll 1 | `backdrops/source/closet_chamber-W/row23-936cd8b3.png` |
