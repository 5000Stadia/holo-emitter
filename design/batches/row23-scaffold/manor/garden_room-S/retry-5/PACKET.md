# garden_room/S — RE-ASK 5 (technique t2, labelled scaffold)
...
| roll 1 | `backdrops/source/garden_room-S/row23-e7df8bee.png` |

The prompt files are already on disk beside them. Do not rewrite them.

This wall: 330.3 px per metre at the wall plane, door.
