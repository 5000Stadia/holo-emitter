# back_stair/N — technique t2 (labelled scaffold)
...
| roll 1 | `backdrops/source/back_stair-N/row23-59449f92.png` |
| roll 2 | `backdrops/source/back_stair-N/row23-98d329eb.png` |

The prompt files are already on disk beside them. Do not rewrite them.

This wall: 329.3 px per metre at the wall plane, no carrier — unbroken panelling.
