# entrance_approach/E — technique t2 (labelled scaffold)
...
| roll 1 | `backdrops/source/entrance_approach-E/row23-3550a6a6.png` |
| roll 2 | `backdrops/source/entrance_approach-E/row23-c7aa80ee.png` |

The prompt files are already on disk beside them. Do not rewrite them.

This wall: 42.7 px per metre at the wall plane, no carrier — unbroken panelling.
