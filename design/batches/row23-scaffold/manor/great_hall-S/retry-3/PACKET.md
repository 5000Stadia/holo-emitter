...
| roll 1 | `backdrops/source/great_hall-S/row23-59198f84.png` |
| roll 2 | `backdrops/source/great_hall-S/row23-07f6400c.png` |

The prompt files are already on disk beside them. Do not rewrite them.

This wall: 115.7 px per metre at the wall plane, window + window + door + window + window.
