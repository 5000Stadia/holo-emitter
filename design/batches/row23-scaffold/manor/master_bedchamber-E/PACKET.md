# master_bedchamber/E — technique t2 (labelled scaffold)
...
| roll 1 | `backdrops/source/master_bedchamber-E/row23-d5e43a87.png` |
| roll 2 | `backdrops/source/master_bedchamber-E/row23-e6cad361.png` |

The prompt files are already on disk beside them. Do not rewrite them.

This wall: 155.2 px per metre at the wall plane, window + window.
