# hall/S — technique t2 (labelled scaffold)
...
| roll 1 | `backdrops/source/passage-S/row23-2d07fa69.png` |
| roll 2 | `backdrops/source/passage-S/row23-5b48e9f7.png` |

The prompt files are already on disk beside them. Do not rewrite them.

This wall: 476.3 px per metre at the wall plane, door.
