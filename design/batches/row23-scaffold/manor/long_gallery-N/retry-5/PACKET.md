# long_gallery/N — RE-ASK 5 (technique t2, labelled scaffold)
...
| roll 1 | `backdrops/source/long_gallery-N/row23-bd4d9cf4.png` |

The prompt files are already on disk beside them. Do not rewrite them.

This wall: 56.2 px per metre at the wall plane, window.
