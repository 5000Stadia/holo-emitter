# great_hall/E — technique t2 (labelled scaffold)
...
| roll 1 | `backdrops/source/great_hall-E/row23-cfe1f41c.png` |
| roll 2 | `backdrops/source/great_hall-E/row23-979c627d.png` |

The prompt files are already on disk beside them. Do not rewrite them.

This wall: 93.5 px per metre at the wall plane, door.
