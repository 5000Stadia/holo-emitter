# great_hall/W — technique t2 (labelled scaffold)
...
| roll 1 | `backdrops/source/great_hall-W/row23-bc41649a.png` |
| roll 2 | `backdrops/source/great_hall-W/row23-fadfdf21.png` |

The prompt files are already on disk beside them. Do not rewrite them.

This wall: 93.5 px per metre at the wall plane, door + door.
