# back_stair/S — technique t2 (labelled scaffold)
...
| roll 1 | `backdrops/source/back_stair-S/row23-0476d1f5.png` |
| roll 2 | `backdrops/source/back_stair-S/row23-d1e5deb8.png` |

The prompt files are already on disk beside them. Do not rewrite them.

This wall: 276.8 px per metre at the wall plane, no carrier — unbroken panelling.
