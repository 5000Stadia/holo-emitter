# entrance_approach/W — RE-ASK 3 (technique t2, labelled scaffold)

> **Why this wall is being asked again**
>
> no candidate of this wall could be measured at all; see MEASURE-ERR lines
...
| roll 1 | `backdrops/source/entrance_approach-W/row23-ec10aaae.png` |
| roll 2 | `backdrops/source/entrance_approach-W/row23-785caeed.png` |

The prompt files are already on disk beside them. Do not rewrite them.

This wall: 42.7 px per metre at the wall plane, no carrier — an unbroken low boundary wall under open sky.
