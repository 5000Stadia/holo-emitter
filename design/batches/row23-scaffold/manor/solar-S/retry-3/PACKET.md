...
| roll 1 | `backdrops/source/solar-S/row23-d7292069.png` |
| roll 2 | `backdrops/source/solar-S/row23-6578955a.png` |

The prompt files are already on disk beside them. Do not rewrite them.

This wall: 115.7 px per metre at the wall plane, window + window + window + window.
