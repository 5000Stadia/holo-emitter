# buttery_pantry/W — technique t2 (labelled scaffold)
...
| roll 1 | `backdrops/source/buttery_pantry-W/row23-f538206d.png` |
| roll 2 | `backdrops/source/buttery_pantry-W/row23-60e8ac08.png` |

The prompt files are already on disk beside them. Do not rewrite them.

This wall: 170.7 px per metre at the wall plane, no carrier — unbroken panelling.
