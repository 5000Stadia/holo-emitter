# study/S — technique t2 (labelled scaffold)
...
| roll 1 | `backdrops/source/study-S/row23-f8bca97e.png` |
| roll 2 | `backdrops/source/study-S/row23-0192dc61.png` |

The prompt files are already on disk beside them. Do not rewrite them.

This wall: 266.0 px per metre at the wall plane, window + window.
