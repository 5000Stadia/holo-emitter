# kitchen/N — technique t2 (labelled scaffold)
...
| roll 1 | `backdrops/source/kitchen-N/row23-71e8ae4a.png` |
| roll 2 | `backdrops/source/kitchen-N/row23-a47d2ab9.png` |

The prompt files are already on disk beside them. Do not rewrite them.

This wall: 157.8 px per metre at the wall plane, door.
