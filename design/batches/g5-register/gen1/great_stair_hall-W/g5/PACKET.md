# Packet — great_stair_hall/W, arm g5 (CLEAN-REGISTER)
...
|---|---|
| 1 | `backdrops/source/great_stair_hall-W/register-4eab59a2.png` |

**The prompt file is already on disk beside where each image goes** (`backdrops/source/great_stair_hall-W/register-4eab59a2.prompt.txt`), written
