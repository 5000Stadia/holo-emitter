# Packet — great_stair_hall/W, arm g5-noappendix (CLEAN-REGISTER, NO APPENDIX)
...
1. `scaffold.png` — **Image 1** — the annotated layout scaffold
...
|---|---|
| 1 | `backdrops/source/great_stair_hall-W/register-3f21465c.png` |

**The prompt file is already on disk beside where each image goes** (`backdrops/source/great_stair_hall-W/register-3f21465c.prompt.txt`), written
