# Packet — entrance_court/S, arm g5 (CLEAN-REGISTER)
...
|---|---|
| 1 | `backdrops/source/entrance_court-S/register-c1cc614d.png` |

**The prompt file is already on disk beside where each image goes** (`backdrops/source/entrance_court-S/register-c1cc614d.prompt.txt`), written
