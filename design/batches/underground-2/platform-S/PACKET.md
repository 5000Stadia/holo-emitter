...
**Image 2 is this wall's edge seed.** `edge-seed-left.png` is the 10 % of `backdrops/platform/E.png` that abuts this picture — its right-hand 154 columns, full frame height, cut by `tools/crop-edge-seed.py` (sha256 `e080e14a9fba` from a painting at `ae86700aa213`). The prompt names its role in words: _Image 2 is a reference of exactly what sits at this picture's left edge - the scene continues from it seamlessly._
