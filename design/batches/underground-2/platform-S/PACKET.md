# platform/S — technique t2 (labelled scaffold)
...
**Image 2 is this wall's edge seed.** `edge-seed-left.png` is the 10 % of `backdrops/platform/E.png` that abuts this picture — its right-hand 154 columns, full frame height, cut by `tools/crop-edge-seed.py` (sha256 `510840cf2a25` from a painting at `057f53711c30`). The prompt names its role in words: _Image 2 is a reference of exactly what sits at this picture's left edge - the scene continues from it seamlessly._
...
| roll 1 | `backdrops/source/platform-S/row23-614418d6.png` |
| roll 2 | `backdrops/source/platform-S/row23-e2703ce7.png` |
