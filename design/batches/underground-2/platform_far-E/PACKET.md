...
| roll 2 | `backdrops/source/platform_far-E/row23-6d3f2346.png` |

The prompt files are already on disk beside them. Do not rewrite them.

This wall: 197.5 px per metre at the wall plane, no carrier — unbroken cream crackle-glazed tiling above the dado band with dark bottle-green glazed tiles below.
