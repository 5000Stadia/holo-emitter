...
**Image 3 is this wall's edge seed.** `edge-seed-right.png` is the 10 % of `backdrops/platform_far/W.png` that abuts this picture — its left-hand 154 columns, full frame height, cut by `tools/crop-edge-seed.py` (sha256 `6e5adb2bd2b9` from a painting at `7d6180a744f0`). The prompt names its role in words: _Image 3 is a reference of exactly what sits at this picture's right edge - the scene continues from it seamlessly._
