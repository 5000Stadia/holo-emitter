...
- room "back_stair" facing N: its standpoint (27.674999999999997, 15.7875) stands ON the "back_stair_flight" flight — the drawing puts the viewer partway up a staircase, and the picture draws the flight around them; it is on the approved sheet, so it is reported rather than moved
- room "great_stair_hall" facing E: its standpoint (2.8, 11.375) stands ON the "great_stair" flight — the drawing puts the viewer partway up a staircase, and the picture draws the flight around them; it is on the approved sheet, so it is reported rather than moved
- room "back_stair_head" facing N: its standpoint (27.674999999999997, 15.7875) stands ON the "back_stair_flight" flight — the drawing puts the viewer partway up a staircase, and the picture draws the flight around them; it is on the approved sheet, so it is reported rather than moved
- room "stair_landing" facing E: its standpoint (2.8, 11.375) stands ON the "great_stair" flight — the drawing puts the viewer partway up a staircase, and the picture draws the flight around them; it is on the approved sheet, so it is reported rather than moved
