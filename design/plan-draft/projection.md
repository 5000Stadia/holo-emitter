...
- room "back_stair" facing N: its standpoint (27.674999999999997, 15.7875) stands ON the "back_stair_flight" flight — the drawing puts the viewer partway up a staircase, so the flight lies at and behind the eye and THIS FACING DRAWS NO FLIGHT: the only part in front of you is the tread under your feet, nearer than a hand's breadth and below the frame. It is on the approved sheet, so it is reported rather than moved
- room "great_stair_hall" facing E: its standpoint (2.8, 11.375) stands ON the "great_stair" flight — the drawing puts the viewer partway up a staircase, so the flight lies at and behind the eye and THIS FACING DRAWS NO FLIGHT: the only part in front of you is the tread under your feet, nearer than a hand's breadth and below the frame. It is on the approved sheet, so it is reported rather than moved
- room "back_stair_head" facing N: its standpoint (27.674999999999997, 15.7875) stands ON the "back_stair_flight" flight — the drawing puts the viewer partway up a staircase, so the flight lies at and behind the eye and THIS FACING DRAWS NO FLIGHT: the only part in front of you is the tread under your feet, nearer than a hand's breadth and below the frame. It is on the approved sheet, so it is reported rather than moved
- room "stair_landing" facing E: its standpoint (2.8, 11.375) stands ON the "great_stair" flight — the drawing puts the viewer partway up a staircase, so the flight lies at and behind the eye and THIS FACING DRAWS NO FLIGHT: the only part in front of you is the tread under your feet, nearer than a hand's breadth and below the frame. It is on the approved sheet, so it is reported rather than moved
...
- object "desk1": the study viewer stands level with it on S, W — its own ground edge is at or behind those cameras, so it belongs to no picture from them and §4b item 9's variant manifest does not enumerate them
- object "chair1": the study viewer stands level with it on S, W — its own ground edge is at or behind those cameras, so it belongs to no picture from them and §4b item 9's variant manifest does not enumerate them
- object "shelf1": the hall viewer stands level with it on W — its own ground edge is at or behind those cameras, so it belongs to no picture from them and §4b item 9's variant manifest does not enumerate them
- object "shelf1": the hall viewer stands within 0.25 m of it on S — its projection is finite and positive and still not a picture of it (a 1 m object at 0.1 m draws 10,240 px/m on a 1,536 px canvas), so §4b item 9's variant manifest does not enumerate those facings either
- object "stick1": the hall viewer stands level with it on W — its own ground edge is at or behind those cameras, so it belongs to no picture from them and §4b item 9's variant manifest does not enumerate them
