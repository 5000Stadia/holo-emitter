...
- [felt — earned 2026-08-21; travels home at close] **A round flag routed into the builder's own
  ...
  Navigator (SendMessage/mail), never prose in the report-to-come. Also earned same row: the
  Navigator staging a shared design doc while a builder holds uncommitted edits to it sweeps the
  builder's hunks into a mislabeled commit — check the diff for foreign hunks before staging
  shared files, or have the builder commit first.
