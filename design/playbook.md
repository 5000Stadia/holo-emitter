...
- **§3.1 reference-first** maps to: the orientation contract governs prompt discipline; Kabe curates
  ...
  the contract, gates checking arrivals, Kabe's eye batched at the flip test. The intention's
  *Where it goes* holds the mechanics; no standing second seat — "written context beats lived
  context; the spec already made that bet."
